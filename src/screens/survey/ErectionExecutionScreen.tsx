        ...
        <ScrollView style={styles.scrollList} contentContainerStyle={styles.scrollListContent} keyboardShouldPersistTaps="handled">
          {filteredLines.length === 0 ? (
            <View style={styles.emptyCard}>
              <Text style={styles.emptyText}>NO ERECTIONS MATCH FILTER</Text>
              <Text style={styles.emptySubText}>Tap the floating icon in the bottom right corner to log a new erection execution.</Text>
            </View>
          ) : (
          ...
          <View style={styles.modalCard}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {isChoosingLtStart ? 'SELECT STARTING POINT' : 'NEW ERECTION EXECUTION'}
              </Text>
            ...
            {isChoosingLtStart ? (
              ...
              <TouchableOpacity style={styles.launchSurveyBtn} onPress={handleStartNewSurvey}>
                <Text style={styles.launchSurveyText}>START ERECTION</Text>
              </TouchableOpacity>
              </ScrollView>
            )}
          </View>
